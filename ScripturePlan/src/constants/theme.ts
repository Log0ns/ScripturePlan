...
export const getRingStyle = (timeOfDay: TimeOfDay): string => {
  const styles: Record<TimeOfDay, string> = {
    morning: 'ring-amber-300 shadow-lg shadow-amber-300/30',
    afternoon: 'ring-teal-300 shadow-lg shadow-teal-300/30',
    evening: 'ring-rose-400 shadow-lg shadow-rose-400/30',
